...
//playing the exercise
    ...
    //onclicklisteners on lights
   /* @OnClick(R.id.light_one)
    public void lightOneClicked() {

        timestamps.add(System.currentTimeMillis());
        if (oneCheck) {
            lightOne.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
            oneCheck = false;
            ...
            lightOne.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
            oneCheck = true;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[0] = '-';
            solLine = String.valueOf(solLineChars);
        ...
        @OnClick(R.id.light_two)
        public void lightTwoClicked() {
            twoCheck = true;

            timestamps.add(System.currentTimeMillis());
            if (twoCheck) {
                lightTwo.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                twoCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[1] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightTwo.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                twoCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[1] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_three)
    public void lightThreeClicked() {
        threeCheck = true;
            timestamps.add(System.currentTimeMillis());
            if (threeCheck) {
                lightThree.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                threeCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[2] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightThree.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                threeCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[2] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_four)
    public void lightFourClicked() {
        fourCheck = true;
            timestamps.add(System.currentTimeMillis());
            if (fourCheck) {
                lightFour.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                fourCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[3] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightFour.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                fourCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[3] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_five)
    public void lightFiveClicked() {
        fiveCheck = true;
            timestamps.add(System.currentTimeMillis());
            if (fiveCheck) {
                lightFive.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                fiveCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[4] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightFive.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                fiveCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[4] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_six)
    public void lightSixClicked() {
        sixCheck = true;
            timestamps.add(System.currentTimeMillis());
            if (sixCheck) {
                lightSix.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                sixCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[5] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightSix.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                sixCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[5] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_seven)
    public void lightSevenClicked() {
        sevenCheck = true;
            timestamps.add(System.currentTimeMillis());
            if (sevenCheck) {
                lightSeven.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                sevenCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[6] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightSeven.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                sevenCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[6] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_eight)
    public void lightEightClicked() {
        eightCheck = true;
        timestamps.add(System.currentTimeMillis());
            if (eightCheck) {
                lightEight.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                eightCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[7] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightEight.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                eightCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[7] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_nine)
    public void lightNineClicked() {
        nineCheck = true;
        timestamps.add(System.currentTimeMillis());
            if (nineCheck) {
                lightNine.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                nineCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[8] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightNine.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                nineCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[8] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_ten)
    public void lightTenClicked() {
        tenCheck = true;
        timestamps.add(System.currentTimeMillis());
            if (tenCheck) {
                lightTen.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                tenCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[9] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightTen.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                tenCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[9] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_eleven)
    public void lightElevenClicked() {
        elevenCheck = true;
            timestamps.add(System.currentTimeMillis());
            if (elevenCheck) {
                lightEleven.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                elevenCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[10] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightEleven.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                elevenCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[10] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_twelve)
    public void lightTwelveClicked() {
        twelveCheck = true;
        timestamps.add(System.currentTimeMillis());
            if (twelveCheck) {
                lightTwelve.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                twelveCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[11] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightTwelve.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                twelveCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[11] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_thirteen)
    public void lightThirteenClicked() {
        thirteenCheck = true;
        timestamps.add(System.currentTimeMillis());
            if (thirteenCheck) {
                lightThirteen.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
                thirteenCheck = false;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[12] = '*';
                solLine = String.valueOf(solLineChars);
                ...
                lightThirteen.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
                thirteenCheck = true;
                char[] solLineChars = solLine.toCharArray();
                solLineChars[12] = '-';
                solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_fourteen)
    public void lightFourteenClicked() {
        fourteenCheck = true;
        timestamps.add(System.currentTimeMillis());
        if (fourteenCheck) {
            lightFourteen.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
            fourteenCheck = false;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[13] = '*';
            solLine = String.valueOf(solLineChars);
            ...
            lightFourteen.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
            fourteenCheck = true;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[13] = '-';
            solLine = String.valueOf(solLineChars);
        ...
        @OnClick(R.id.light_fifteen)
        public void onClick (View view){
        fifteenCheck = true;
        timestamps.add(System.currentTimeMillis());
        if (fifteenCheck) {
            lightFifteen.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
            fifteenCheck = false;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[14] = '*';
            solLine = String.valueOf(solLineChars);
            ...
            lightFifteen.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
            fifteenCheck = true;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[14] = '-';
            solLine = String.valueOf(solLineChars);
    ...
    @OnClick(R.id.light_sixteen)
    public void lightSixteenClicked() {
        sixteenCheck = true;
        clicker(light16, sixteenCheck);*/

        /*timestamps.add(System.currentTimeMillis());
        if (sixteenCheck) {
            lightSixteen.setImageResource(R.drawable.ic_radio_button_unchecked_red_24dp);
            sixteenCheck = false;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[15] = '*';
            solLine = String.valueOf(solLineChars);
            ...
            lightSixteen.setImageResource(R.drawable.ic_radio_button_unchecked_black_24dp);
            sixteenCheck = true;
            char[] solLineChars = solLine.toCharArray();
            solLineChars[15] = '-';
            solLine = String.valueOf(solLineChars);
